<template>
    <div class="flex flex-col justify-center h-screen max-w-[19rem] space-y-2 mx-auto my-auto">
        ...
        <div class="space-y-4">
            ...
            <TextInput class="w-full" v-model="email" inputName="email" id="email" type="email"/>            
            <TextInput class="w-full" v-model="password" inputName="password" id="password" type="password" pattern=".{8,}" @keydown.enter="confirm"/>
        </div>
